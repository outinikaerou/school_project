...
HD_PWD='Z:/github/Vivado/CNT60_ALL/CNT60_ALL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CNT60_ALL.vdi -applog -m64 -messageDb vivado.pb -mode batch -source CNT60_ALL.tcl -notrace
