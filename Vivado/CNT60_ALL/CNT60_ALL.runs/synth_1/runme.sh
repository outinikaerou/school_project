...
HD_PWD='Z:/github/Vivado/CNT60_ALL/CNT60_ALL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CNT60_ALL.vds -m64 -mode batch -messageDb vivado.pb -notrace -source CNT60_ALL.tcl
